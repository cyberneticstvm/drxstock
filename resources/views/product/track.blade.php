                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-lg-1">
                                ...
                                {{ html()->select('cyl', $powers->where('name', 'cyl')->pluck('value', 'value') + array('0.00' => '0.00'), old('cyl') ? old('cyl') : $inputs[4])->class("form-control form-control-lg select2")->placeholder("Select") }}
                            </div>
