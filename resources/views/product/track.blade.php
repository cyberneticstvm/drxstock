                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 mt-1">
                            <div class="col-lg-1">
                                ...
                                {{ html()->select('sph', $powers->where('name', 'sph')->pluck('value', 'value'), old('sph') ? old('sph') : $inputs[3])->class("form-control form-control-lg select2 sph")->placeholder("Select") }}
                            </div>
                            <div class="col-lg-1">
                                <label for="SquareInput" class="form-label">Cyl</label>
                                {{ html()->select('cyl', $powers->where('name', 'cyl')->pluck('value', 'value'), old('cyl') ? old('cyl') : $inputs[4])->class("form-control form-control-lg select2 cyl")->placeholder("Select") }}
                            </div>
                            <div class="col-lg-1 divAxis">
                                <label for="SquareInput" class="form-label">Axis</label>
                                {{ html()->select('axis', $powers->where('name', 'axis')->pluck('value', 'value'), old('axis') ? old('axis') : $inputs[5])->class("form-control form-control-lg select2 selAxis")->placeholder("Select") }}
                            </div>
                            <div class="col-lg-1 divAdd">
                                <label for="SquareInput" class="form-label">Add</label>
                                {{ html()->select('add', $powers->where('name', 'add')->pluck('value', 'value'), old('add') ? old('add') : $inputs[6])->class("form-control form-control-lg select2 selAdd")->placeholder("Select") }}
                            </div>
