                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-lg-1">
                                ...
                                {{ html()->select('cyl', array('0.00' => '0.00')+ $powers->where('name', 'cyl')->pluck('value', 'value'), old('cyl') ? old('cyl') : $inputs[4])->class("form-control form-control-lg select2")->placeholder("Select") }}
                            </div>
