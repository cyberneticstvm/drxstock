                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ html()->select('product_id[]', $products, '')->class("form-control form-control-lg select2 selPdct")->attribute('data-qty', 0)->attribute('id', $item->pid)->placeholder("Select")->required() }}
                                            </td>
                                            <td>
