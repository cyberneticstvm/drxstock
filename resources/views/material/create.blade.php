            ...
            <div class="col-lg-12">
                <div class="card bg-white">
                    <div class="card-header py-3 border-bottom-0">
                        <h6 class="card-title mb-0">Create Material</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6 col-md-6">
                                ...
                                {{ html()->text('name', old('name'))->class("form-control form-control-lg")->placeholder("Material Name") }}
                                @error('name')
                        ...
                        <div class="row g-3">
                            <div class="col text-end">
                                {{ html()->submit("Save Material")->class("btn btn-submit btn-dark btn-lg") }}
                            </div>
                        </div>
                        {{ html()->form()->close() }}
                    </div>
