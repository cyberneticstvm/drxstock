                        ...
                        <table class="myDataTable table table-hover align-middle mb-0" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->username }}</td>
                                    <td>{{ $item->email }}</td>
                                    <td><span class="badge bg-info">{{ ucfirst($item->role) }}</span></td>
                                    <td>{!! $item->status() !!}</td>
                                    <td class="text-center"><a href="{{ route('user.edit', encrypt($item->id)) }}"><i class="fa fa-magic text-warning"></i></a></td>
                                    <td class="text-center"><a class="dlt" href="{{ route('user.delete', encrypt($item->id)) }}"><i class="fa fa-trash text-danger"></i></a></td>
                                </tr>
                                @empty
                                @endforelse
                            </tbody>
